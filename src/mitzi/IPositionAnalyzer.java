...
public interface IPositionAnalyzer {
	 ...
	 * @return the value of the board in centipawns
	 */
	 ...
	 * @param alpha the alpha value of the alpha-beta algorithm
	 * @param beta  the beta value of the alpha-beta algorithm
	 * @return the value of the board in centipawns
	 */
